        ...
        <div className="mx-auto max-w-5xl">
          ...
          >
            ...
            <div className="flex items-center gap-1 sm:gap-4">
              ...
              <Link
                to="/vagas"
                className="rounded-full px-2.5 sm:px-3 py-1 font-sans text-xs sm:text-sm text-white/80 hover:text-white hover:bg-white/10 transition-colors inline-flex items-center gap-1.5"
              >
