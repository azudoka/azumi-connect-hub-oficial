...
export const PROJETOS_MOCK: ProjetoCliente[] = [
  ...
  {
    id: "proj-horizonte-1",
    codigo: "PROJ-2026-HZ01",
    nome: "Estruturação de Plano de Cargos",
    empresaId: "horizonte",
    ...
    entregaveis: [
      {
        id: "ent-hz-001",
        codigo: "ENT-2026-HZ01",
        nome: "Diagnóstico inicial dos cargos atuais",
        frente: "Estrutura organizacional",
        complexidade: "C1",
        status: "aprovado_cliente",
        prazo: DAYS_AGO(10),
      ...
      {
        id: "ent-hz-002",
        codigo: "ENT-2026-HZ02",
        nome: "Matriz de cargos preliminar",
        frente: "Estrutura organizacional",
        complexidade: "C2",
        status: "aprovacao_cliente",
        prazo: DAYS_AHEAD(8),
        subtarefas: 4,
        tipoDocumento: true,
        aprovacaoEnviadaEm: HOURS_AGO(20),
      },
      {
        id: "ent-hz-003",
        codigo: "ENT-2026-HZ03",
        nome: "Política salarial — proposta",
        frente: "Estrutura organizacional",
        complexidade: "C2",
        status: "em_andamento",
        prazo: DAYS_AHEAD(25),
  ...
  },
  {
    ...
    entregaveis: [
      {
        id: "ent-vt-001",
        codigo: "ENT-2026-VT01",
        nome: "Diagnóstico de lideranças por unidade",
        frente: "Liderança",
        complexidade: "C1",
        status: "aprovado_cliente",
        prazo: DAYS_AGO(18),
      ...
      {
        id: "ent-vt-002",
        codigo: "ENT-2026-VT02",
        nome: "Trilha de desenvolvimento — Módulo 1",
        frente: "Liderança",
        complexidade: "C2",
        status: "aprovacao_cliente",
        prazo: DAYS_AHEAD(5),
        subtarefas: 6,
        tipoDocumento: true,
        aprovacaoEnviadaEm: HOURS_AGO(12),
      },
      {
        id: "ent-vt-003",
        codigo: "ENT-2026-VT03",
        nome: "Workshop NR-32 — material",
        frente: "Compliance",
        complexidade: "C2",
        status: "em_andamento",
        prazo: DAYS_AHEAD(18),
  ...
  {
    id: "proj-vita-2",
    codigo: "PROJ-2026-VT02",
    nome: "Onboarding Clínico",
    empresaId: "vita",
    consultor: "Juliana Costa",
    consultorIniciais: "JC",
    status: "vigente",
    ...
    entregaveis: [
      {
        id: "ent-vt-010",
        codigo: "ENT-2026-VT10",
        nome: "Manual de onboarding — v2",
        frente: "Onboarding",
        complexidade: "C2",
        status: "em_andamento",
        prazo: DAYS_AHEAD(14),
      ...
      {
        id: "ent-vt-011",
        codigo: "ENT-2026-VT11",
        nome: "Treinamento de acolhimento",
        frente: "Onboarding",
        complexidade: "C1",
        status: "nao_iniciado",
        prazo: DAYS_AHEAD(30),
